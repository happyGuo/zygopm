...
// If PanicOnDie is seting to true a panic will occur instead of os.Exit being
// called.
...
// Default Messenger. If PanicOnDie is seting to true a panic will occur instead of
